...
void UZMQController::HandleResetCommand()
{
    ...
    DronePawn->SetActorLocation(InitialPosition, false, nullptr, ETeleportType::TeleportPhysics);
    DronePawn->SetActorRotation(FRotator::ZeroRotator);

    if (UPrimitiveComponent* RootPrimitive = Cast<UPrimitiveComponent>(DronePawn->GetRootComponent()))
    {
